...
if(isset($_GET['q']) && isset($_GET['p'])){
	...
	header("location: http://kingdomlubricants.com");
}
...
<head>
	<title>Search : Kingdom Lubricants</title>
	<!-- for-mobile-apps -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="shortcut icon" href="images/favicon.png">

<!-- FB OG -->
<meta property="og:title" content="Search : Kingdom Lubricants" />
...
general manufacturing industries. synthetic oils, semi-synthetic oils and greases, high performance industrial lubricants
and graphite based lubricants are our key area of excellence." />
<meta name="twitter:title" content="Search : Kingdom Lubricants" />
	...
	<meta name="url-identifier" content="http://kingdomlubricants.com/search.php">
					...
					<ul>
						<li class="agileinfo_share">
							<form class="form-inline" method="get" action="search.php">
								...
								<input type="hidden" name="p" value="search.php">
							</form>
						</li>
