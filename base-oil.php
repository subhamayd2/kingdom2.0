...
<head>
    <title>Base Oil | Kingdom Lubricants</title>
    <!-- for-mobile-apps -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" href="images/favicon.png">

    <!-- FB OG -->
	<meta property="og:title" content="Base Oil | Kingdom Lubricants" />
...
and graphite based lubricants are our key area of excellence."
	/>
	<meta name="twitter:title" content="Base Oil | Kingdom Lubricants" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="modalImageWrapper">
                            <img src="" alt="Base Oil" id="productModalImage">
                        </div>
                    </div>
                ...
                <ul>
                    <li class="agileinfo_share">
                        <form class="form-inline" method="get" action="search.php">
                            ...
                            <input type="hidden" name="p" value="base-oil.php">
                        </form>
                    </li>
    ...
    $(".view a").on('click', function(e){
        ...
        json.data.forEach(function(el) {
            if(el.ProductName == name && el.ProductSubCategory == subcategory){
                ...
                var link = "enquiry-cart.php?product="+el.ProductName+"&q=0&p=0&c=Base Oil&sc="+subcategory;
