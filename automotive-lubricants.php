...
<head>
	<title>Automotive Lubricants | Kingdom Lubricants</title>
	<!-- for-mobile-apps -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="shortcut icon" href="images/favicon.png">

<!-- FB OG -->
	<meta property="og:title" content="Automotive Lubricants | Kingdom Lubricants" />
...
and graphite based lubricants are our key area of excellence."
	/>
	<meta name="twitter:title" content="Automotive Lubricants | Kingdom Lubricants" />
	...
	<meta name="url-identifier" content="http://kingdomlubricants.com/automotive-lubricants.php">
...
<div class="modal fade" tabindex="-1" role="dialog" id="productModal">
  <div class="modal-dialog" role="document">
					...
					<ul>
						<li class="agileinfo_share">
							<form class="form-inline" method="get" action="search.php">
								...
								<input type="hidden" name="p" value="automotive-lubricants.php">
							</form>
						</li>
	...
	<div class="portfolio">
		<div class="container">
			<h2 class="w3ls_head">Automotive Lubricants</h2>
			<div class="portfolio-agile">
			<ul class="nav nav-tabs nav-justified" role="tablist" id="products-tabs">
    			<li role="presentation" class="active"><a href="#gasoline" aria-controls="home" role="tab" data-toggle="tab">Gasoline</a></li>
    			<li role="presentation"><a href="#diesel" aria-controls="diesel" role="tab" data-toggle="tab">Diesel</a></li>
    			<li role="presentation"><a href="#gearoil" aria-controls="gearoil" role="tab" data-toggle="tab">Gear Oil</a></li>
    			<li role="presentation"><a href="#transimisson" aria-controls="transimisson" role="tab" data-toggle="tab">Transmission Fluid</a></li>
				<li role="presentation"><a href="#stroke" aria-controls="stroke" role="tab" data-toggle="tab">Stroke</a></li>
  			</ul>

			  <div class="tab-content">
    			<div role="tabpanel" class="tab-pane active" id="gasoline">

					<div class="main">
				<?php
				for($i = 0; $i < count($l); $i++){
					if($l[$i]['ProductSubCategory'] == "Gasoline"){
    			...
    			<div role="tabpanel" class="tab-pane fade" id="diesel">
					
					<div class="main">
				<?php
				for($i = 0; $i < count($l); $i++){
					if($l[$i]['ProductSubCategory'] == "Diesel"){
    			...
    			<div role="tabpanel" class="tab-pane fade" id="gearoil">

					<div class="main">
				<?php
				for($i = 0; $i < count($l); $i++){
					if($l[$i]['ProductSubCategory'] == "Gear Oil"){
						echo '<div class="col-sm-3">';
						echo '<div class="view view-seventh">';
							echo '<a data-name="'. $l[$i]['ProductName'] .'" data-subcategory="'. $l[$i]['ProductSubCategory'] .'" href="#" rel="title" class="b-link-stripe b-animate-go  thickbox">';
								echo '<img src="' . $l[$i]['ProductImage'] . '" />';
    			...
    			<div role="tabpanel" class="tab-pane fade" id="transimisson">

					<div class="main">
				<?php
				for($i = 0; $i < count($l); $i++){
					if($l[$i]['ProductSubCategory'] == "Transmission Fluids"){
						echo '<div class="col-sm-3">';
						echo '<div class="view view-seventh">';
							echo '<a data-name="'. $l[$i]['ProductName'] .'" data-subcategory="'. $l[$i]['ProductSubCategory'] .'" href="#" rel="title" class="b-link-stripe b-animate-go  thickbox">';
								echo '<img src="' . $l[$i]['ProductImage'] . '" />';
				...
				<div role="tabpanel" class="tab-pane fade" id="stroke"><div class="main">
				<?php
				for($i = 0; $i < count($l); $i++){
					if($l[$i]['ProductSubCategory'] == "Strokes"){
						echo '<div class="col-sm-3">';
						echo '<div class="view view-seventh">';
							echo '<a data-name="'. $l[$i]['ProductName'] .'" data-subcategory="'. $l[$i]['ProductSubCategory'] .'" href="#" rel="title" class="b-link-stripe b-animate-go">';
								echo '<img src="' . $l[$i]['ProductImage'] . '" />';
								echo '<div class="mask">';
									echo '<h2>' . $category . '</h2>';
									echo '<p>' . $l[$i]['ProductDescriptionShort'] . '</p>';
	...
	$(".view a").on('click', function(e){
		...
		json.data.forEach(function(el) {
			if(el.ProductName == name && el.ProductSubCategory == subcategory){
				...
				var link = "enquiry-cart.php?product="+el.ProductName+"&q=0&p=0&c=Automotive Lubricants&sc="+subcategory;
